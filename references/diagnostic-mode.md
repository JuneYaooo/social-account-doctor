...
如果账号以带货内容为主，继续读取 `references/commerce-workflow.md`，在 Layer 2 保证对标账号同品类、同内容形态，在 Layer 3 追加商品露出、利益点顺序、证明动作、信任点、CTA、商品一致性和合规风险。没有商家/创作者后台数据时，不根据公开互动推断商品点击率、成交率、GMV 或佣金。
