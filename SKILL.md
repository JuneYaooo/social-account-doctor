...
工具：
- 小红书 `xiaohongshu_app_search_notes`（**只用这个**，V2/Web V2 全挂 — 见 §9）
...
| 任务 | 小红书 | 抖音 | 快手 |
|---|---|---|---|
| **find Step 3 关键词搜** | `xiaohongshu_app_search_notes`（**唯一可用**，见 §9） | `douyin_app_v3_fetch_video_search_result_v2` | `kuaishou_app_search_video_v2` |
...
## 9. 小红书接口稳定性表（实测 2026-04-21，**所有 V2 全挂，只用 V1**）
