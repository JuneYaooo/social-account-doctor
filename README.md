...
> 小红书 / 抖音 / 快手 / 视频号 / B 站 自媒体的**账号体检 + 爆款拆解**工具，**同时支持带货电商模式**。
> 给它一个账号链接，它告诉你：你的号在同赛道什么位置、top 在做什么你没做、这条为什么不爆、下一步该往哪改。顺手出一版可粘贴的仿写初稿。
> 给它一个商品链接，它告诉你：这个品怎么卖、对标爆款怎么拍的、你的口播脚本和分镜该怎么写。
...
- **手上有品不知道怎么做带货** → 给商品链接，自动出商品事实卡 + 对标爆款 + 口播脚本 + 分镜，附带风险标注告诉你能不能这么说
...
- **看得懂商品** —— 给一个商品链接，分析卖点/痛点/买点/利益点，拆解带货对标爆款的 5 个电商维度（商品露出、利益点排序、转化链、商品卡一致性、翻拍风险评估），出 15s/30s/60s 口播脚本和分镜
